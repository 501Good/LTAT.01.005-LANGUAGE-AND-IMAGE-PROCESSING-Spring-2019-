...
def evaluate(beam_size):
    ...
    loader = torch.utils.data.DataLoader(
        CaptionDataset(data_folder, data_name, 'TEST', vocab=word_map, transform=None),
    ...
    # For each image
    for i, (image, caps, caplens, allcaps, img_name) in enumerate(
        ...
        while True:
            ...
            print(next_word_inds, incomplete_inds)
